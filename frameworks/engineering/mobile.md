    ...
    content:
      - level: 1
        criteria:
          ...
          - "Asks questions and actions feedback from PRs and other guild members"
      ...
      - level: 5
        criteria:
          ...
          - "Instills and maintains a culture of high quality interaction design in their guild"
        exampleCriteria:
          - criteria: "Coordinates group efforts across horizontal"
            examples:
              - "A technical authority for iOS/Android on multiple teams, working with team leads and other guild members across the company."
